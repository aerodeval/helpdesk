<template>
  <Popover transition="default">
    ...
    <template #body="{ togglePopover }">
      ...
      >
        <div
          class="size-5 cursor-pointer rounded-full bg-surface-transparent text-md"
        ...
        >
          ...
          <div class="px-3" v-for="(emojis, group) in emojiGroups" :key="group">
            ...
            <div class="grid w-96 grid-cols-12 place-items-center">
              <button
                class="h-8 w-8 rounded-md p-1 text-md hover:bg-surface-gray-2 focus:outline-none focus:ring focus:ring-blue-200"
